...
namespace MatSharp {
    ...
    public static class MatrixExtensionMethods {
        ...
        public static double Determinant(this Matrix<double> matrix)
            => matrix.Determinant(Enumerable.Range(0, matrix.Rows), Enumerable.Range(0, matrix.Columns));
        ...
        public static Matrix<double> Add(this Matrix<double> m, Matrix<double> matrix)
            => m.Add(matrix, 1);
        ...
        public static Matrix<double> Multiply(this Matrix<double> m, Matrix<double> matrix)
            => m.Multiply(matrix,1);
